========================================================================
    BIBLIOTHÈQUE DE LIENS DYNAMIQUES : Vue d'ensemble du projet InputOutputLibrary
========================================================================

AppWizard a créé cette DLL InputOutputLibrary pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application InputOutputLibrary.


InputOutputLibrary.vcxproj
...
InputOutputLibrary.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) InputOutputLibrary.pch et un fichier de type précompilé nommé StdAfx.obj.
